...
<head>
  ...
  <title>EcompJr - Meu Perfil</title>
</head>
...
<body>
  <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
    ...
    <form class="form-group" action="/Treinamento2020/user/update/<?php echo $user->getId()?>" method="post" onsubmit="return validarSenha()" name="form">
